...
public final class HorizontalPager extends ViewGroup {
	...
	public void setImageIterator(ImageIterator iterator) {
		this.imageIterator = iterator;
	}

	public void initialize() {
		TouchImageView imageView = new TouchImageView(getContext());
		imageView.setImageBitmap(imageIterator.getNextPage());
		addView(imageView);				
